...
/**
 * Set release in issue
 * This method set release for an issue on Issues.
 * @param int   repoId      github id of repository
 * @param int   issueNumber github id of issue
 * @param object    payload      contains estimate to set for the issue, see https://github.com/IssuesIO/API#set-estimate-for-issue for payload format
 *   @example `{  "add_issues": [{ "repo_id": 103707262, "issue_number": 3 }],  "remove_issues": [] }`
 * @memberof    Issues
 * @method      setReleaseForIssue
 */
Issues.prototype.setReleaseForIssue = function (releaseId, payload) {
